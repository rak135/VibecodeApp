...
# Path prefixes (POSIX, relative to repo root) whose contents are generated by
# normal workflows.  Exact HUMAN_MAINTAINED_PATHS entries are checked first, so
# .vibecode/index/README.md and .vibecode/index/schema.json remain protected
# even though other .vibecode/index/* outputs are generated.
