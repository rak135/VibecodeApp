...
Passing `.` is explicit and means the current working directory, not the active
registry project.
...
- **Generated index status** — what was indexed and whether the index is stale
...
│
├── index/                     ← MIXED: README.md/schema.json are human-maintained; generated maps are regenerated by `vibecode index`
│   ├── file_inventory.json
│   ├── symbol_map.json
│   ├── dependency_map.json
│   ├── test_map.json
...
- generated `.vibecode/index/*` outputs such as `file_inventory.json`, `symbol_map.json`, `dependency_map.json`, `test_map.json`, `entrypoints.md`, `risky_files.md`, and `repo_tree.generated.md`; only `.vibecode/index/README.md` and `.vibecode/index/schema.json` are committed source truth
- `.vibecode/current/*`
- `.vibecode/generated/*`
- `.vibecode/logs/*`
- `.vibecode/runs/*`
